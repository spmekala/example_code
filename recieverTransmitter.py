...
class Reciever (threading.Thread):
    ...
    def run(self):
        if not (self.poc_address[0] == '0.0.0.0' and self.poc_address[1] == 0):
            tempPacket = "4" + self.poc_address[0] + "," + str(self.poc_address[1])
            self.q.put((tempPacket.encode('utf-8'), self.poc_address))
            self.seenAddress.append(self.poc_address)
        while True:
            # try:
            #     error = None
            #     result = None
    ...
    def analyze(self, data, addr):
        ...
        if packetType == '4':
            print("Peer Discovery packet recieved")
            ...
            if packetType == '1':
                ...
                print("RTT packet recieved")
            elif packetType == '5':
                print("acknowledge packet recieved")
            else:
